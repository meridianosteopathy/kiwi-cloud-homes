 ...
 *
 * Zone status:
 *   - in-zone: home is in the school's primary catchment (MoE zone)
 *   - nearby: a short drive away; private/open-enrolment, or outside this home's zone
...
export const SCHOOLS: School[] = [
  // In zone — the home's primary catchments
  {
    id: "halswell-school",
    districtId: "halswell",
    cityId: "christchurch",
    regionId: "canterbury",
    name: { zhCN: "Halswell 学校 (小学)", en: "Halswell School" },
    distanceKm: 0.8,
    zone: "in-zone",
  },
  {
    ...
    cityId: "christchurch",
    regionId: "canterbury",
    name: { zhCN: "Oaklands 学校 (小学)", en: "Oaklands School" },
    distanceKm: 2.5,
    zone: "in-zone",
  },
  {
